...
void part2(){
    ...
    //draw all the points in the list
    // Render r1 = Render();
    // for (list<Point>::iterator i = pointss.begin(); i != pointss.end(); i++)
    // {
    //     r1.drawcircle(i->getXCon(), i->getYCon(), 3);
    //     r1.drawcircle(i->getXCon(), i->getYCon(), 2);

    // }
    // r1.coldrawcircle(r.getP1().getXCon(), r.getP1().getYCon(), 3, 2);
    // r1.coldrawcircle(r.getP1().getXCon(), r.getP1().getYCon(), 2, 2);
    // r1.coldrawcircle(r.getP2().getXCon(), r.getP2().getYCon(), 3, 2);
    // r1.coldrawcircle(r.getP2().getXCon(), r.getP2().getYCon(), 2, 2);
    // r1.createppm("points2");
}
